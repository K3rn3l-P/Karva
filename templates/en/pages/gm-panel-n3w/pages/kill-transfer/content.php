...
<div class="page">
    ...
    <div class="page-body border_box self_clear">
		...
		<!-- begin content -->
		<center><p style="color:#ff00ff">IMPORTANT: <br>1. In order to transfer kills Account must be OFFLINE! <br>2. In order to transfer kills both Characters must be in same account!</p></center>
