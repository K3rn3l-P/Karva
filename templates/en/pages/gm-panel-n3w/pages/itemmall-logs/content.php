<div class="page">
    ...
    <div class="page-body border_box self_clear">
		...
		$queryLog = $conn->prepare('SELECT * FROM PS_GameData.dbo.PointLog WHERE UserUID = ? ORDER BY UseDate DESC');
		...
		odbc_exec($odbcConn, "INSERT INTO [PS_WebSite].[dbo].[AdminLog] ([UserUID],[UserID],[Action],[Text],[IP])
				VALUES ($UserUID, '$UserID', 'Access to Item Mall logs', '', '$UserIP')");
		}
		?>
		<!-- end content -->	
