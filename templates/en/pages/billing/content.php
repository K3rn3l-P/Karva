<?php $assetPath = "templates/en/pages/billing/";
   ...
   $serverURL = "https://s.pinto-lime.ts.net//";
                           ...
                           <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                 <div class="modal-content">
									...
									<p><span aria-hidden="true" style="color:red;"> &#9888;</span>   Please do not close the PayPal window after donation is complete, wait for PayPal to redirect back to our website <b>www.shaiyaDuff.com</b></p>
