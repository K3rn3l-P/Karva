<div class="page">
    ...
    <div class="page-body border_box self_clear">
		...
		$queryAccount2 = $conn->prepare("SELECT * FROM PS_Website.dbo.Payments WHERE method='Paypal' ORDER BY date DESC");
		$queryAccount2->execute();


		echo "<table id='control' style='width:692px;'>";

		echo "<tr>	<th>Transation ID</th>
					<th>User Name</th>
					<th>SP </th>
					<th>Method </th>
					<th>Date</th>
		...
		while ($charAccount2 = $queryAccount2->fetch(PDO::FETCH_NUM)) {
			...
			$queryAccount1->bindParam(1, $charAccount2[2], PDO::PARAM_INT);
			$queryAccount1->execute();
			$charAccount1 = $queryAccount1->fetch(PDO::FETCH_NUM);

			//print_r($charAccount1);die;

			echo "<tr>
					<td>" . $charAccount2[1] . "</td>
					<td>" . $charAccount1[0] . "</td>
