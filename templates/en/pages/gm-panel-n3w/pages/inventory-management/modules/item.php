...
<tr>
	...
	<td class="action-column">
		<?php if ($isWarehouse) : ?>
			...
			<a href='<?= $TemplateUrl ?>/actions/gm-panel-n3w/warehouse-management/removeall.php?uid=<?= $row["UserUID"] ?>&item=<?= $row["ItemUID"] ?>'>Delete all</a><br />
			<a href='/?p=gm-panel-n3w&sp=item-edit&uid=<?= $row["ItemUID"] ?>'>Edit item</a>
		<?php else : ?>
			...
			<a href='<?= $TemplateUrl ?>/actions/gm-panel-n3w/inventory-management/removeall.php?cid=<?= $row["CharID"] ?>&item=<?= $row["ItemUID"] ?>'>Delete all</a><br />
			<a href='/?p=gm-panel-n3w&sp=item-edit&uid=<?= $row["ItemUID"] ?>'>Edit item</a>
		<?php endif ?>
	</td>
</tr>