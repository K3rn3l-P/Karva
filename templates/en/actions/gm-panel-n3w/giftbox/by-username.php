<?php
$query = $conn->prepare("SELECT UserUID, UserID FROM PS_UserData.dbo.Users_Master WHERE UserID = ?");
...
// Log action
$logActionQuery = "INSERT INTO [PS_WebSite].[dbo].[AdminLog] ([UserUID],[UserID],[Action],[Text],[IP]) VALUES (?, ?, 'Adding item to giftbox by username', 'ITEM: $itemid; COUNT: $count; UID: {$userData['UserUID']}; USERNAME: {$userData['UserID']}', ?)";
