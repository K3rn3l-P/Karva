...
// Verifica se l'oggetto è nella lista degli oggetti proibiti
$forbiddenItems = array(25229, 25230, 25231, 25232, 25233, 94001, 94002, 94003, 94004, 94005, 94006, 100220, 100221);
if (in_array($ItemID, $forbiddenItems)) {
    SetErrorAlert("Restore forbidden item");
    header("Location: $BackUrl");
    exit;
}
...
$stmt = $pdo->prepare("INSERT INTO PS_GameData.dbo.UserStoredItems (ServerID, UserUID, ItemID, ItemUID, Type, TypeID, Slot, Quality, Gem1, Gem2, Gem3, Gem4, Gem5, Gem6, Craftname, [Count], Maketime, Maketype, Del)
            VALUES (1, :UserUID, :ItemID, :ItemUID, :Type, :TypeID, :Slot, 0, :Gem1, :Gem2, :Gem3, :Gem4, :Gem5, :Gem6, :Craftname, :count, CURRENT_TIMESTAMP, 'X', 0)");
$stmt->execute(array(
