<div class="page">
    ...
    <div class="page-body border_box self_clear">
        ...
        while ($charAccount2 = $queryAccount2->fetch(PDO::FETCH_ASSOC)) {
            $queryAccount1 = $conn->prepare('SELECT UserID FROM PS_UserData.dbo.Users_Master WHERE UserUID= ? ');
            $queryAccount1->bindParam(1, $charAccount2['UserUID'], PDO::PARAM_INT);
            $queryAccount1->execute();
            $charAccount1 = $queryAccount1->fetch(PDO::FETCH_ASSOC);
            echo "<tr>
                    
                    <td>" . htmlspecialchars($charAccount2['UserUID']) . "</td>
                    <td>" . htmlspecialchars($charAccount2['SP']) . "</td>
                    <td>" . htmlspecialchars($charAccount2['Method']) . "</td>
                    <td>" . htmlspecialchars($charAccount2['Date']) . "</td>
                    </tr>";
        }
        echo "</table>";

        // Commentato perché non è chiaro cosa dovrebbe fare e potrebbe essere un'operazione non sicura
