...
<iframe class="not-active" src="https://freesecure.timeanddate.com/clock/i79o89lj/n49/fc009fff/tc000/pc009fff/ftb/tt0/th1" frameborder="0" width="299" height="18"></iframe>
				...
				<span class="r_status">x120</span>
				<br>
				<span class="r_name overflow_ellipsis">Kill Rate: </span>
				<span class="r_status">x1</span>
				<br>
				<span class="r_name overflow_ellipsis">Week Kill Rate: </span>
				<span class="r_status">x5</span>
			...
			<div class="r_bar border_box">
					...
					<center> <p> New players join <span style="color:#196ded">Alliance of Light</span>  </p> </center>	
				</div>
			</div>
