<?php
$userID = isset($_GET["username"]) ? htmlspecialchars($_GET["username"]) : "";
$charName = isset($_GET["charname"]) ? htmlspecialchars($_GET["charname"]) : "";
$marketID = isset($_GET["marketid"]) && is_numeric($_GET["marketid"]) && $_GET["marketid"] > 0 ? $_GET["marketid"] : 0;
$rows = isset($_GET["rows"]) && is_numeric($_GET["rows"]) && $_GET["rows"] > 0 ? $_GET["rows"] : 100;
$statuses = isset($_GET["status"]) ? htmlspecialchars($_GET["status"]) : "any";
