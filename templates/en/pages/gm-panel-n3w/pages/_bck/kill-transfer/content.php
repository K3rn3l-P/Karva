...
<div class="page">
    ...
    <div class="page-body border_box self_clear">
        <!-- begin content -->
        <center><p style="color:#ff00ff">IMPORTANT: In order to transfer kills, both characters must be in the same account!</p></center>
        
        <div class="node format">
            <?php include("modules/search.php") ?>
            <?php include($Username && $Chars ? "modules/list.php" : "modules/notexists.php") ?>
        </div>
        <!-- end content -->	
    </div>
</div>
...
function TransferTo(CharID) {
    ...
    window.location.href = "<?= $TemplateUrl ?>actions/gm-panel-n3w/kill-transfer.php?id=" + CharID + "&name=" + Name;
}
</script>
