...
$stmt = $pdo->prepare("SELECT CharID FROM PS_GameData.dbo.Chars WHERE UserUID = :UID AND CharName = :charName AND Del = 0");
$stmt->execute(array(':UID' => $UID, ':charName' => $charName));
